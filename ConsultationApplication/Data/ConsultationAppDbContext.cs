...
{
    public class ConsultationAppDbContext : IdentityDbContext<AppUser>
    {
        public ConsultationAppDbContext(DbContextOptions<ConsultationAppDbContext> options) : base(options)
        {
        }
